...
model_dict = dict(
    ...
    # none affine version
    Conv4_na=backbone_no_affine.Conv4,
    Conv4S_na=backbone_no_affine.Conv4S,
    Conv6_na=backbone_no_affine.Conv6,
    ResNet10_na=backbone_no_affine.ResNet10,
    ResNet18_na=backbone_no_affine.ResNet18,
    ResNet34_na=backbone_no_affine.ResNet34,
    ResNet50_na=backbone_no_affine.ResNet50,
    ResNet101_na=backbone_no_affine.ResNet101)
...
def parse_args(script):
    ...
    parser.add_argument('--seed', default=10, type=int, help='seed the random values')
